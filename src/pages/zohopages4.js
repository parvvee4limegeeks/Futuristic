...
export default class zohopages1 extends Component {
    render() {
        return (
            ...
            <IFrame url="https://analytics.zoho.com/open-view/1254398000007257836/b3c76d748d1b3c5cb577a7015edbbd60"
             width="1280px"
             height="650px"
            id="myId"
            ...
            <IFrame url="https://analytics.zoho.com/open-view/1254398000007257883/cd621a0f659caee97232232e980aa007"
             width="1280px"
             height="650px"
            id="myId"
            className="myClassname"
